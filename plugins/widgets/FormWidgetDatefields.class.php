...
class FormWidgetDatefields extends FormWidgetAbstract
{
    public function widgetConfigurationForm(array $form_state, array $configuration, $lang, array $stored_values, $available_values) {
        ...
        $form['configuration']['field_from_label'] = array(
            ...
            '#default_value' => isset($configuration['field_from_label']) ? $configuration['field_from_label'] : t("From", null, $lang),
            '#required' => true,
            '#size' => 20,
            '#weight' => 3,
        );
        ...
        $form['configuration']['field_to_label'] = array(
            ...
            '#default_value' => isset($configuration['field_to_label']) ? $configuration['field_to_label'] : t("To", null, $lang),
            '#required' => true,
            '#size' => 20,
            '#weight' => 4,
        );
